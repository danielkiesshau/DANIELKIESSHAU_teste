...
class Motorista{
    ...
    public function insertMotorista(){
        try{
            ...
            //Redirecting page
           header('Location: https://whispering-eyrie-32116.herokuapp.com/Paginas/HTML/motorista.html?error=0'); 

        }catch(PDOException $e){
            echo '<br/>ERROR '.$e->getMessage().'<br/> Line:'.$e->getLine().'<br/>'.$e->getFile();
            //Redirecting page
            header('Location: https://whispering-eyrie-32116.herokuapp.com/Paginas/HTML/motorista.html?error=1'); 
    ...
    public function updateMotorista(){
        try{
            ...
            //Redirecting page
            header('Location: https://whispering-eyrie-32116.herokuapp.com/Paginas/HTML/motorista.html'); 
...
<body>
    ...
    <div id="update" style="display:none;"><?php if(isset($_GET['update'])){echo $_GET['update'];}?></div>
    ...
    <script type=text/javascript>
        ...
        if(update == 0){
            ...
            $(document).ready(function(){
                ...
                window.location.href="https://whispering-eyrie-32116.herokuapp.com/Paginas/HTML/motorista.html?table=1";
