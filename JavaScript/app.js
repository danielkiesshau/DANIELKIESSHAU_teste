...
function init(){
    ...
    window.location = 'http://localhost/Projeto/Paginas/index.php?nome='+motorista.getNome()+"&dt_nascimento="+motorista.getDataNasc()+"&cpf="+motorista.getCPF()+"&modelo_car="+motorista.getModeloCar()+"&status="+motorista.getStatus()+"&sexo="+motorista.getSexo();
    return false;
